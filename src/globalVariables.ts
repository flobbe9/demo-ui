...
export const PAGE_WIDTH_PORTRAIT = "770px";
export const PAGE_WIDTH_LANDSCAPE = "1095px";
...
/** Number of lines to subtract from NUM_LINES variables just because calculations are inaccurate and might result in rendering too many lines in one column. */
const NUM_SAFETY_LINES = 1;

/** assuming a fontSize of 14 */
export const NUM_LINES_PROTRAIT = 41 - NUM_FILLER_LINES - NUM_SAFETY_LINES;
/** assuming a fontSize of 19 */
export const MAX_FONT_SIZE_SUM_PORTRAIT = NUM_LINES_PROTRAIT * DEFAULT_FONT_SIZE;

/** assuming a fontSize of 14 */
export const NUM_LINES_LANDSCAPE = 29 - NUM_FILLER_LINES - NUM_SAFETY_LINES;
/** assuming a fontSize of 19 */
...
const NUM_LINES_PROTRAIT_OLD: ReadonlyArray<Object> = [{
    8: 76 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    9: 68 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    10: 61 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    11: 54 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    12: 51 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    14: 44 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    16: 38 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    18: 34 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    20: 31 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    22: 28 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    24: 26 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    26: 24 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    28: 22 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    36: 17 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    48: 13 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    72: 9 - NUM_FILLER_LINES - NUM_SAFETY_LINES
}];

const NUM_LINES_LANDSCAPE_OLD: ReadonlyArray<Object> = [{
    8: 53 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    9: 47 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    10: 43 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    11: 39 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    12: 36 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    14: 31 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    16: 28 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    18: 25 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    20: 23 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    22: 21 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    24: 19 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    26: 18 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    28: 17 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    36: 14 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    48: 11 - NUM_FILLER_LINES - NUM_SAFETY_LINES,
    72: 8 - NUM_FILLER_LINES - NUM_SAFETY_LINES
}];